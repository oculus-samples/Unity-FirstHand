...
TEXTURE2D(_DetailUV2);    SAMPLER(sampler_DetailUV2); 
...
inline void InitializeStandardLitSurfaceData(float2 uv, out SurfaceData outSurfaceData)
{
    ...
    outSurfaceData.albedo = ApplyDetailAlbedo(detailUv, outSurfaceData.albedo, 1);// detailMask);
